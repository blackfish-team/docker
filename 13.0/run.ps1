...
docker run -u 0 -p 8069:8069 -p 8888:8888 --name odoo-dev  -v ${BlackAddonsSource}:/mnt/black-addons --link db:db -t odoo-dev /usr/bin/python3 -m debugpy --listen 0.0.0.0:8888 /usr/bin/odoo --db_user=odoo --db_host=db --db_password=odoo